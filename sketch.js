var bg,s,g,gg,cg,c,eb,e,r,score=0,gamestate=1,ib,pb,bg1,pl,lb,star,rb,nl,hl
function preload(){
bg1=loadImage("hh.jpg");hl=loadImage("halo.jpg");pb=loadImage("play.png")
ib=loadImage("windows.png");bg=loadImage("icon.png");g=loadImage("p.png")
ss=loadAnimation("s1.png","s2.png","s3.png","s4.png","s3.png","s2.png","s1.png")
star=loadImage("ssss.png");cc=loadImage("tii.png");eb=loadImage("eg.png")
e=loadImage("e.png");rs=loadImage("h.png");lb=loadImage("wb.png")
...
nl.visible=false
rb.visible=false
image(bg,0,0,5000,height)
/*image(eb,camera.position.x-100,50,250,50)
if(score!=0)
image(e,camera.position.x-20,51,(score/10)*50,48)*/
//textSize(30)
//fill("white")
